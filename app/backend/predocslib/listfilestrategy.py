...
class File:
    ...
    def __init__(self,content : IO,acls:Optional[dict[str,list]] = None,url : Optional[int] = None):
    ...
    def filename_to_id(self):
        ...
        return f"{filename_ascii}_{filename_hash}_{acls_hash}"
            ...
            async for path in self.list_paths():
                ...
                try:
                    ...
                    try:
                        ...
                        logger.error(f"\t\tFailed to delete temporary file {temp_file_path} after error: {file_delete_exception}")
