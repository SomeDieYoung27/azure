        ...
        async with DocumentIntelligenceClient(
            ...
            if self.use_content_understanding:
                if self.content_understanding_endpoint is None:
                    raise ValueError("Content understanding endpoint must be provided when use_content_understanding is True")
                ...
                #mark all the positions of the table spans in the pages
                ...
                for idx,mask_char in enumerate(mask_chars):
                    ...
                    if object_type == ObjectType.NONE:
                        ...
                        if cu_describer is None:
                            raise ValueError("cu_describer should not be None, unable to describe figur")
                        if object_idx is None:
                            raise ValueError("Expected object_idx to be set")
...
async def figure_to_html(
    ...
    page_number = first_region["pageNumber"]
