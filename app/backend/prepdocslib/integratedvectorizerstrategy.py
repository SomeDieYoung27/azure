...
class IntegratedVectorizerStrategy(Strategy):
    ...
    async def run(self):
        ...
        logger.info( f"Successfully created index, indexer: {indexer_result.name}, and skillset. Please navigate to search service in Azure Portal to view the status of the indexer.")
